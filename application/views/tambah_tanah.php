						...
						<form class="form-horizontal" action="" method="post">
							<fieldset>
								...
								<div class="form-group">
									...
									<div class="col-md-9">
									<input name="kepemilikan" type="text" class="form-control" placeholder="kepemilikan"; ?>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-9">
									<input name="atasnama_sertifikat" type="text" class="form-control" placeholder="atasnama_sertifikat"; ?>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-9">
									<input name="status_tanah" type="text" class="form-control" placeholder="status_tanah"; ?>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-9">
									<input name="luas_tanah" type="text" class="form-control" placeholder="luas_tanah"; ?>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-9">
									<input name="no_sertifikat" type="text" class="form-control" placeholder="no_sertifikat"; ?>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-9">
									<input name="thn_perolehan" type="text" class="form-control" placeholder="thn_perolehan"; ?>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-9">
									<input name="asal_usul" type="text" class="form-control" placeholder="asal_usul"; ?>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-9">
									<input name="letak" type="text" class="form-control" placeholder="letak"; ?>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-9">
									<input name="peruntukan" type="text" class="form-control" placeholder="peruntukan"; ?>
									</div>
								</div>
